...
are a type of Vertical Unmanned Aerial Vehicle (VUAV), that have various applications such as investigation, strategic operation, optical sensing, and entertainment \cite{article_nano}.
...
To provide a faster control command in facing the modeling error and reduce the disturbance effect in the attitude control, the model-based control strategies \cite{9696294} including nonlinear control, intelligent control, optimal control, and robust control have been implemented on the ACS of the quadrotor.
...
% is a highly accomplished aerospace engineer with a passion for intelligent control, optimization, and machine learning.
