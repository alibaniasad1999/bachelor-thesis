...
\begin{figure}[h]
	\centering
	\subfloat[\label{fig:all_roll}]{\includegraphics[width=.95\linewidth]{../Figure/implementation/lqidgvslqr/roll}}
	\hfil
	\subfloat[\label{fig:all_pitch}]{\includegraphics[width=.95\linewidth]{../Figure/implementation/lqidgvslqr/pitch}
	}
...
\begin{figure}[H]
	\centering
	{\includegraphics[width=.95\linewidth]{../Figure/implementation/box_plot/lqidgvsboxplot}
	}
