...
\begin{figure}[!h]
	\includegraphics[width=6cm]{../Figures/RCP/roll_parameter_estimation/RCP_roll_S4.png}
	\centering
	\caption{شماتیک استند چهارپره}
	\label{QuadAssum}
\end{figure}
...
\begin{figure}[h]
	\includegraphics[width=6cm]{../Figures/RCP/pitch_parameter_estimation/RCP_pitch_S1.png}
	\centering
	\caption{شماتیک استند چهارپره}
	\label{QuadAssum}
\end{figure}
