...
\begin{equation}\label{LQIDG_u}
	\boldsymbol{\mathrm{u_i}}(t) = -\boldsymbol{\mathrm{R_{ii}}}^{-1}\boldsymbol{\mathrm{B_{a_i}}}^\mathrm{T}\boldsymbol{\mathrm{K_{a_i}}}(t)\boldsymbol{\mathrm{x_a}}(t),\quad i = 1, 2
\end{equation}
که در رابطه 
(\ref{LQIDG_u})
...
\begin{equation}\label{coupled_riccatti_LQIDG}
	\begin{split}
		\boldsymbol{\dot{\mathrm{K}}_{a_1}}(t) &= -\boldsymbol{\mathrm{A_a}}^\mathrm{T}\boldsymbol{\mathrm{K_{a_1}}}(t) - \boldsymbol{\mathrm{K_{a_1}}}(t)\boldsymbol{\mathrm{A_a}} - \boldsymbol{\mathrm{Q_1}} +\boldsymbol{\mathrm{K_{a_1}}}(t)\boldsymbol{\mathrm{S_{a_1}}}(t)\boldsymbol{\mathrm{K_{a_1}}}(t) + \boldsymbol{\mathrm{K_{a_1}}}(t)\boldsymbol{\mathrm{S_{a_2}}}(t)\boldsymbol{\mathrm{K_{a_2}}}(t)\\
		\boldsymbol{\dot{\mathrm{K}}_{a_2}}(t) &= -\boldsymbol{\mathrm{A_a}}^\mathrm{T}\boldsymbol{\mathrm{K_{a_2}}}(t) - \boldsymbol{\mathrm{K_{a_2}}}(t)\boldsymbol{\mathrm{A_a}} - \boldsymbol{\mathrm{Q_2}} +\boldsymbol{\mathrm{K_{a_2}}}(t)\boldsymbol{\mathrm{S_{a_2}}}(t)\boldsymbol{\mathrm{K_{a_2}}}(t) + \boldsymbol{\mathrm{K_{a_2}}}(t)\boldsymbol{\mathrm{S_{a_1}}}(t)\boldsymbol{\mathrm{K_{a_1}}}(t)
	\end{split}
\end{equation}
