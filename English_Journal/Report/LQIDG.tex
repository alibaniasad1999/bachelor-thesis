...
\begin{figure}[H]
	...
	(a) somparison of simulation and experimental results. (b) identification of $\Gamma_2$ and $\Gamma_5$.}
...
% \begin{figure}[H]
	...
	\caption{Identification process results when the quadrotor rotates about its roll, pitch, and yaw axes: (a) somparison of simulation and experimental results. (b) identification of $\Gamma_1$ , $\Gamma_4$ and
	$\Gamma_7$ parameters.}
