...
\begin{figure}[H]
	...
	\begin{tikzpicture}[font=\small,thick]
		...
		\node[draw, align=center,
			minimum width=2.5cm,
			minimum height=1cm] (block1) {\textbf{Experimental data} \\Blade rotational speed as input variables \\ current attitude as output};
		...
		minimum width=3cm,
		minimum height=2.5cm
		] (block_s) {{simulated model}\\\includegraphics[scale=.05]{../Figure/All-six.png}};
		...
		\node[draw,
			below=1.5cm of block4,
			minimum height=1cm,
			minimum width=2.5cm,
			inner sep=0] (block5) {End};
		 
		\node[draw,
			right=2cm of block4,
			minimum height=1cm,
			minimum width=2.5cm,
			] (block6) {Need More Experimental Data};
