...
\begin{align}\label{eq:diffeq}
	...
	\dot x_2 &= \dfrac{\mathrm{I}_{\text{zz}} - \mathrm{I}_{\text{zz}}}{\mathrm{I}_{\text{yy}}} x_1 x_3 - x_1 \dfrac{\mathrm{I}_{\text{rotor}}}{\mathrm{I}_{\text{xx}}}\Omega_r + \dfrac{u_{\text{pitch}}}{\mathrm{I}_{\text{yy}}} + \dfrac{d_{\text{pitch}}}{\mathrm{I}_{\text{yy}}}\\[0.5em] \label{eq:diffeq-mid}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{../Figure/parameter_estimation/roll/roll}
    \caption{3DoF setup of the quadrotor.}
    \label{fig:quadrotor}
\end{figure}
