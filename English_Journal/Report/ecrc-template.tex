...
\noindent The LQR-DG controller is augmented with an integral action to eliminate steady-state errors in desired following. The first step in the controller design is to define the augmented state space of the linear quadrotor model to incorporate it into the controller architecture. Subsequently, the LQR-DG controller design procedure is introduced to generate optimal control commands for the experimental quadrotor setup.
