...
\begin{figure}[!h]
	\centering
	\subfloat[]{\includegraphics[width=.49\linewidth]{../Figure/implementation/lqidg_roll}\label{fig:roll}\includegraphics[width=.49\linewidth]{../Figure/implementation/lqidg_pitch}
	}
	\hfil
...
\begin{figure}[!h]
	\centering
	\subfloat[]{\includegraphics[width=.49\linewidth]{../Figure/implementation/lqidg_Omega_1}\label{fig:roll}\includegraphics[width=.49\linewidth]{../Figure/implementation/lqidg_Omega_2}
	}
	\hfil
	\subfloat[]{\includegraphics[width=.49\linewidth]{../Figure/implementation/lqidg_Omega_3}\label{fig:pitch}\includegraphics[width=.49\linewidth]{../Figure/implementation/lqidg_Omega_4}
	}
