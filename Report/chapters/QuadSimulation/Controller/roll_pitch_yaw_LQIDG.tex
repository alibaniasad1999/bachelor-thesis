...
\subfigure[تغییرات زاویه رول]{
	\centering
	\includegraphics[width=.55\linewidth]{../Figures/MIL/LQIDG/3DOF/lqidg_roll.png}
}
\subfigure[تغییرات زاویه پیچ]{
	\centering
	\includegraphics[width=.55\linewidth]{../Figures/MIL/LQIDG/3DOF/lqidg_pitch.png}
}
\subfigure[تغییرات زاویه یاو]{
	\centering
	\includegraphics[width=.55\linewidth]{../Figures/MIL/LQIDG/3DOF/lqidg_yaw.png}
}
