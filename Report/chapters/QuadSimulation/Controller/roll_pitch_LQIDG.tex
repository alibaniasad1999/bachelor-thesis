...
%	
%\end{figure}
\begin{figure}[H]\label{lqidg_roll_pitch_fig_simulation}
	\centering
	\subfigure[تغییرات زاویه رول]{
		\centering
		\includegraphics[width=.6\linewidth]{../Figures/MIL/LQIDG/Roll_Pitch/lqidg_roll.png}
	}
	\subfigure[تغییرات زاویه پیچ]{
		\centering
		\includegraphics[width=.6\linewidth]{../Figures/MIL/LQIDG/Roll_Pitch/lqidg_pitch.png}
	}
