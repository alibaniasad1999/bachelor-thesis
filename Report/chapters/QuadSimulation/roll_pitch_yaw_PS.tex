...
\begin{figure}[H]
	...
	\subfigure[تغییرات زاویه رول]{
		\centering
		\includegraphics[width=.55\linewidth]{../Figures/RCP/roll_pitch_yaw_parameter_estimation/RCP_roll.png}
	}
	\subfigure[تغییرات زاویه پیچ]{
		\centering
		\includegraphics[width=.55\linewidth]{../Figures/RCP/roll_pitch_yaw_parameter_estimation/RCP_pitch.png}
	}
	\subfigure[تغییرات زاویه یاو]{
	\centering
	\includegraphics[width=.55\linewidth]{../Figures/RCP/roll_pitch_yaw_parameter_estimation/RCP_yaw.png}
}
	\caption{مقايسه وضعیت استند در  آزمايش چهارم و شبیه‌سازی، پس از تخمین پارامترهای کانال رول-پیچ-یاو}
