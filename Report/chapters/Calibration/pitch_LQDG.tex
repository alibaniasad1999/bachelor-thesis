\section{شبیه‌سازی کانال رول استند در حضور کنترل‌کننده \lr{LQDG}}
در بخش
\ref{roll_LQDG_section_simulation}
شبیه‌سازی تک کانال استند چهارپره در حضور کنترل‌کننده \lr{LQDG} انجام شد. در این بخش به پیاده‌سازی کنترل‌کننده \lr{LQDG} بر رویه کانال پیچ استند سه درجه آزادی پرداخته می‌شود.
...
\begin{figure}[H]
	...
	\centering
	\caption{عملكرد \lr{LQDG} در کنترل زاويه پیچ (تعقیب ورودی صفر)}
\end{figure}
