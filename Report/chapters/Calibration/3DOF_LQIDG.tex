...
\begin{figure}[H]
	...
	\subfigure[تغییرات زاویه رول]{
		\centering
		\includegraphics[width=.6\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_roll.png}
	}
	\subfigure[تغییرات زاویه پیچ]{
		\centering
		\includegraphics[width=.6\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_pitch.png}
	}
	\subfigure[تغییرات زاویه یاو]{
	\centering
	\includegraphics[width=.6\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_yaw.png}
}
