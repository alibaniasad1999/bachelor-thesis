...
ابتدا کانال رول استند چهارپره در حضور کنترل‌کننده \lr{LQR} و سپس در حضور کنترل‌کننده‌های \lr{LQDG} و \lr{LQIDG} شبیه‌سازی شد. سپس، کانال‌های رول-پیچ و رول-پیچ-یاو در بخش های
\ref{roll_lqr_section_simulation}
و
