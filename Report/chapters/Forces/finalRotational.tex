\section{ استخراج معادله نهایی دينامیک دورانی}\label{sec:finalrotate}
...
\begin{align}
	...
	\end{split}\\[1em]
		\begin{split}
		\dot{q} =& \dfrac{h_{cg}gm_{tot}\sin(\theta)
	...
	\end{split}
\end{align}
به منظور انتشار وضعیت دورانی چهارپره، از روش انتشار اویلر به‌صورت زیر استفاده می‌شود
