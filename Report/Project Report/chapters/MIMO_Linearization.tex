\subsection{خطی‌سازی به فرم \lr{MIMO}}\label{lin_MIMO}
...
\begin{equation}
	\delta \dot x = \dfrac{\partial a}{\partial x}\delta x + \dfrac{\partial a}{\partial\omega}\delta \omega 
\end{equation}
\begin{equation}
	\dot{\vec{x}} =
	\begin{bmatrix}
...
\end{equation}
\begin{equation}
	B = \dfrac{\partial \vec a}{\partial \vec \omega} = 
	\begin{bmatrix}
