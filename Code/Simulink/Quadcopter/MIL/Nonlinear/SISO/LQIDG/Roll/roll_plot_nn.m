...
print('../../../../../../../../Figures/MIL/LQIDG/Roll/lqidg_rollnn_.png','-dpng','-r400');
% subplot(2,1,2);
...
print('../../../../../../../../Figures/MIL/LQIDG/Roll/lqidg_roll_omega_2nn_.png','-dpng','-r400');
plot(out.tout, omega_4, 'k');
xlabel('time($\sec)$', 'interpreter', 'latex', 'FontSize', 16);
ylabel('$\omega_{4_{(rad/\sec)}}$', 'interpreter', 'latex', 'FontSize', 18);
print('../../../../../../../../Figures/MIL/LQIDG/Roll/lqidg_roll_omega_4nn_.png','-dpng','-r400');
