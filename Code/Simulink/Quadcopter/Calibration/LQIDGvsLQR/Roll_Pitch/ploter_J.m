...
plot(time_new-5, 180/pi*LQIR_roll_pitch(:, 1), ':b', 'linewidth', 2);
plot(time_new-5, -180/pi*roll_pitch_LQR.signals.values(:, 1), '-.', 'linewidth', 2);
plot(time_new-5, -180/pi*roll_pitch_PID(:, 1), '+g', 'linewidth', .001);
...
plot(time_new-5, -180/pi*LQIR_roll_pitch(:, 2), ':b', 'linewidth', 2);
plot(time_new-5, 180/pi*roll_pitch_LQR.signals.values(:, 2), '-.', 'linewidth', 2);
plot(time_new-5, 180/pi*roll_pitch_PID(:, 2), '+g', 'linewidth', .02);
hold off;
axis([0 10 -60 60])
legend('Setpoint', 'LQIR-DG', 'LQIR', 'LQR', 'PID', 'Location','northeast', 'FontSize', 20);
set(gca, 'FontSize', 16, 'FontName', 'Times New Roman');
