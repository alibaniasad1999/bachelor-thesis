...
plot(omega_data.tout-3.5 , 60/2/pi*omega_data.omega_film_1(:, 1), 'k');
set(gca, 'FontSize', 16)
xlabel('time($\sec)$', 'interpreter', 'latex', 'FontSize', 24);
...
plot(omega_data.tout-3.5 , 60/2/pi*omega_data.omega_film_1(:, 2), 'k');
set(gca, 'FontSize', 16)
xlabel('time($\sec)$', 'interpreter', 'latex', 'FontSize', 24);
...
plot(omega_data.tout-3.5 , 60/2/pi*omega_data.omega_film_1(:, 3), 'k');
set(gca, 'FontSize', 16)
xlabel('time($\sec)$', 'interpreter', 'latex', 'FontSize', 24);
...
plot(omega_data.tout-3.5 , 60/2/pi*omega_data.omega_film_1(:, 4), 'k');
set(gca, 'FontSize', 16)
xlabel('time($\sec)$', 'interpreter', 'latex', 'FontSize', 24);
