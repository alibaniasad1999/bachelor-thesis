...
% hold off;
print('../../../../../../../../Figures/RCP/roll_ml_parameter_estimation/RCP_roll_S1.png',...
    '-dpng','-r400');
%% scenario II
% subplot(2,1,1);
% % roll
...
% ylabel('roll rate$_{(rad/\sec)}$', 'interpreter', 'latex', 'FontSize', 18);
% hold off;
print('../../../../../../../../Figures/RCP/roll_ml_parameter_estimation/RCP_roll_S2.png',...
    '-dpng','-r400');
%% scenario III
% subplot(2,1,1);
% roll
...
% ylabel('roll rate$_{(rad/\sec)}$', 'interpreter', 'latex', 'FontSize', 18);
% hold off;
print('../../../../../../../../Figures/RCP/roll_ml_parameter_estimation/RCP_roll_S3.png',...
    '-dpng','-r400');
%% scenario IV
% subplot(2,1,1);
% % roll
...
% ylabel('roll rate$_{(rad/\sec)}$', 'interpreter', 'latex', 'FontSize', 18);
% hold off;
print('../../../../../../../../Figures/RCP/roll_ml_parameter_estimation/RCP_roll_S4.png',...
    '-dpng','-r400');