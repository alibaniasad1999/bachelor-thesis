...
% hold off;
print('../../../../../../../../Figures/RCP/pitch_ml_parameter_estimation/RCP_pitch_S1.png',...
    '-dpng','-r400');
%% scenario II
% subplot(2,1,1);
% pitch
...
% ylabel('pitch rate$_{(rad/\sec)}$', 'interpreter', 'latex', 'FontSize', 18);
% hold off;
print('../../../../../../../../Figures/RCP/pitch_ml_parameter_estimation/RCP_pitch_S2.png',...
    '-dpng','-r400');
%% scenario III
% subplot(2,1,1);
% pitch
plot(time, out.scenario_III(:, 1), 'k--', 'linewidth', 2);
hold on;
...
% ylabel('pitch rate$_{(rad/\sec)}$', 'interpreter', 'latex', 'FontSize', 18);
% hold off;
print('../../../../../../../../Figures/RCP/pitch_ml_parameter_estimation/RCP_pitch_S3.png',...
    '-dpng','-r400');
%% scenario IV
% subplot(2,1,1);
% pitch
plot(time, out.scenario_IV(:, 1), 'k--', 'linewidth', 2);
hold on;
...
% pitch rate
% subplot(2,1,2); 
% plot(time, out.scenario_IV(:, 2), 'k--', 'linewidth', 2);
% hold on;
...
% ylabel('pitch rate$_{(rad/\sec)}$', 'interpreter', 'latex', 'FontSize', 18);
% hold off;
print('../../../../../../../../Figures/RCP/pitch_ml_parameter_estimation/RCP_pitch_S4.png',...
    '-dpng','-r400');
%% scenario V
% subplot(2,1,1);
% pitch
plot(time, out.scenario_V(:, 1), 'k--', 'linewidth', 2);
hold on;
...
% pitch rate
% subplot(2,1,2); 
% plot(time, out.scenario_V(:, 2), 'k--', 'linewidth', 2);
% hold on;
...
% ylabel('pitch rate$_{(rad/\sec)}$', 'interpreter', 'latex', 'FontSize', 18);
% hold off;
print('../../../../../../../../Figures/RCP/pitch_ml_parameter_estimation/RCP_pitch_S5.png',...
    '-dpng','-r400');