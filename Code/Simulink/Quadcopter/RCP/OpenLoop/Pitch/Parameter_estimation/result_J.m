...
B3_array = zeros(1, 3);
B3_array(1) = B3;
B3_array(2) = SDOSessionData.Data.Workspace.LocalWorkspace.EstimatedParams_1.Parameters.Value;
B3_array(3) = SDOSessionData.Data.Workspace.LocalWorkspace.EstimatedParams_2.Parameters.Value;

plot(0:length(B3_array)-1, B3_array, '*k', 'markersize', 10)
set(gca, 'FontSize', 16, 'FontName', 'Times New Roman');
xlabel('Iterations', 'interpreter', 'latex', 'FontSize', 24);
ylabel('Value of $\Gamma_6$', 'interpreter', 'latex', 'FontSize', 24);
