...
\begin{figure*}[h]
	\centering
	\subfloat[]{\includegraphics[width=.32\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_roll.png}
	}
	\subfloat[]{\includegraphics[width=.32\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_pitch.png}
	}
	\subfloat[]{\includegraphics[width=.32\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_yaw.png}}
	\hfil
	\subfloat[]{\includegraphics[width=.32\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_roll_e.png}
	}
	\subfloat[]{\includegraphics[width=.32\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_pitch_e.png}
	}
	\subfloat[]{\includegraphics[width=.32\linewidth]{../Figures/Calibration/LQIDG/3DOF/lqidg_yaw_e.png}}
