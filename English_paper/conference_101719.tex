...
\begin{figure}[!h]
	\centering
	\subfloat[Roll]{\includegraphics[width=2.5in]{../Figures/RCP/roll_parameter_estimation/RCP_roll_S4.png}
	\label{fig: roll PE}}
	\hfil
	\subfloat[Pitch]{\includegraphics[width=2.5in]{../Figures/RCP/pitch_parameter_estimation/RCP_pitch_S1.png}
	\label{fig: pitch PE}}
	\hfil
	\subfloat[Yaw]{\includegraphics[width=2.5in]{../Figures/RCP/yaw_parameter_estimation/RCP_yaw_S2.png}
	\label{fig: yaw PE}}
	\caption{Comparison of yaw mode states in simulation and reality.} \label{fig_sim}
\end{figure}
