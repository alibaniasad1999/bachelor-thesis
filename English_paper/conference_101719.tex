...
\end{equation}
In equation (\ref{LQDG_u}), $\boldsymbol{\mathrm{K_{i}}}$ is the optimal feedback gain. Assuming that the other players will make their worst move, this gain is calculated to minimize the quadratic cost function (equation \ref{cost}) of player number i.
...
In equation (\ref{LQIDG_u}), $\boldsymbol{\mathrm{K_{a_i}}}$ is the optimal feedback gain. Assuming that the other players will make their worst move, this gain is calculated to minimize the quadratic cost function, equation \ref{cost_LQIDG}, of player number i.
...
% \begin{figure*}[htbp]
%     \centering
%     \subfloat[Case I]{\includegraphics[width=2.5in]{../Figures/MIL/LQIDG/Roll/lqidg_roll.png}
%     \label{fig_first_case}}
%     \hfil
%     \subfloat[Case II]{\includegraphics[width=2.5in]{../Figures/MIL/LQIDG/Roll/lqidg_roll.png}
%     \label{fig_second_case}}
%     \caption{Simulation results for the network.} \label{fig_sim}
% \end{figure*}
% \begin{figure}[htbp]
% 	\centerline{\includegraphics[width=2.5in]{../Figures/MIL/LQIDG/Roll/lqidg_roll.png}}
